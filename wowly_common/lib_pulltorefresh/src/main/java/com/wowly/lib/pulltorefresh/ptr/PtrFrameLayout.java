package com.wowly.lib.pulltorefresh.ptr;
...
import com.wowly.lib.pulltorefresh.R;
import com.wowly.lib.pulltorefresh.ptr.indicator.PtrIndicator;
import com.wowly.lib.pulltorefresh.ptr.util.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.ptr_frameLayout, 0, 0);
        if (arr != null) {
            mHeaderId = arr.getResourceId(R.styleable.ptr_frameLayout_ptr_header, mHeaderId);
            mContainerId = arr.getResourceId(R.styleable.ptr_frameLayout_ptr_content, mContainerId);
            mFooterId = arr.getResourceId(R.styleable.ptr_frameLayout_ptr_footer, mFooterId);

            mPtrIndicator.setResistanceHeader(arr.getFloat(R.styleable.ptr_frameLayout_ptr_resistance, mPtrIndicator.getResistanceHeader()));
            mPtrIndicator.setResistanceFooter(arr.getFloat(R.styleable.ptr_frameLayout_ptr_resistance, mPtrIndicator.getResistanceFooter()));
            mPtrIndicator.setResistanceHeader(arr.getFloat(R.styleable.ptr_frameLayout_ptr_resistance_header, mPtrIndicator.getResistanceHeader()));
            mPtrIndicator.setResistanceFooter(arr.getFloat(R.styleable.ptr_frameLayout_ptr_resistance_footer, mPtrIndicator.getResistanceFooter()));

            mDurationToBackHeader = arr.getInt(R.styleable.ptr_frameLayout_ptr_duration_to_back_refresh, mDurationToCloseHeader);
            mDurationToBackFooter = arr.getInt(R.styleable.ptr_frameLayout_ptr_duration_to_back_refresh, mDurationToCloseHeader);
            mDurationToBackHeader = arr.getInt(R.styleable.ptr_frameLayout_ptr_duration_to_back_header, mDurationToCloseHeader);
            mDurationToBackFooter = arr.getInt(R.styleable.ptr_frameLayout_ptr_duration_to_back_footer, mDurationToCloseHeader);

            mDurationToCloseHeader = arr.getInt(R.styleable.ptr_frameLayout_ptr_duration_to_close_either, mDurationToCloseHeader);
            mDurationToCloseFooter = arr.getInt(R.styleable.ptr_frameLayout_ptr_duration_to_close_either, mDurationToCloseFooter);
            mDurationToCloseHeader = arr.getInt(R.styleable.ptr_frameLayout_ptr_duration_to_close_header, mDurationToCloseHeader);
            mDurationToCloseFooter = arr.getInt(R.styleable.ptr_frameLayout_ptr_duration_to_close_footer, mDurationToCloseFooter);

            float ratio = mPtrIndicator.getRatioOfHeaderToHeightRefresh();
            ratio = arr.getFloat(R.styleable.ptr_frameLayout_ptr_ratio_of_header_height_to_refresh, ratio);
            mPtrIndicator.setRatioOfHeaderHeightToRefresh(ratio);

            mKeepHeaderWhenRefresh = arr.getBoolean(R.styleable.ptr_frameLayout_ptr_keep_header_when_refresh, mKeepHeaderWhenRefresh);

            mPullToRefresh = arr.getBoolean(R.styleable.ptr_frameLayout_ptr_pull_to_fresh, mPullToRefresh);

            mMode = getModeFromIndex(arr.getInt(R.styleable.ptr_frameLayout_ptr_mode, 4));
    ...
    public void autoRefresh(boolean atOnce, boolean isHeader) {
        autoRefresh(atOnce, isHeader, false);
    }

    public void autoRefresh(boolean atOnce, boolean isHeader, boolean onlyUI) {
    ...
    private void performRefreshOnlyUI() {
