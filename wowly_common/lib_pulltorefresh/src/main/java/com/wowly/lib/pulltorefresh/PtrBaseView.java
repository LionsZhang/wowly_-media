...
import com.wowly.lib.pulltorefresh.ptr.PtrDefaultHandler2;
import com.wowly.lib.pulltorefresh.ptr.PtrFrameLayout;
import com.wowly.lib.pulltorefresh.ptr.PtrUIHandler;
 ...
 */
public abstract class PtrBaseView extends LinearLayout {
    ...
    public PtrBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
        onInitMainView();
        mContent = onInitContent();
        initView();
    ...
    public void autoRefershOnlyUI() {
        if (ptrLayout != null) {
            ptrLayout.autoRefresh(true, true, true);
        }
    }
